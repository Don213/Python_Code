...
while(1):
    try:
        ...
        data['kwatt_hours'].append(int(Turbine_StringList[3])/1000)
        ...
        data['kwatt_hours'] = list(map(str, data['kwatt_hours']))
        ...
        for index, row in df.iterrows():
            ...
            + "\nKHSwindturbine Kilowatt_hours=" + (row['kwatt_hours']) + " " + (row['timestamp'])
